...
const ImageEditor = ({
  ...
  return (
    <div className="fixed w-screen h-screen left-0 top-0 bg-gray-800 bg-opacity-75 z-10 flex items-center justify-center">
      <div className="bg-black rounded-xl p-5 flex flex-col gap-4 max-h-[90vh]">
        {/* TOP */}
        ...
        {/* IMAGE CONTAINER */}
        <div className="w-[40vw] max-h-[80vh] flex items-center">
          <Image
            src={previewURL}
            alt=""
            width={500}
